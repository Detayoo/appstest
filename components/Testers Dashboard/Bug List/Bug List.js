...
const TesterBugList = () => {
  return (
    <div className="mt-[15px] h-[100vh] bg-white mr-[-15px]">
      <div className="flex items-center justify-between bug-list mr-[15px]">
        <div className="w-[28%]">
          ...
          <br />
          <div className="border-[1px] border-black/30 flex justify-between items-center mt-[4px] pl-[10px] pr-[15px] py-[7px] rounded-[5px]">
      ...
      <div className="ml-[-15px] mt-[20px] flex h-14 items-center text-green text-[14px] p-[10px] ">
        ...
        <div className="w-[10%] py-[10px] px-[15px]">Severity</div>
      </div>
      ...
      <div className="bg-lightAsh flex  pl-[2px]  items-center text-[13px]">
        ...
        <div className="w-[10%]">
          <div className="relative w-[95px] h-[40px]">
            <Image src="/icons/Declined Status.svg" layout="fill" />
          </div>
        </div>
      ...
      <div className="flex pl-[2px]  items-center text-[13px]">
        ...
        <div className="w-[10%]">
          <div className="relative w-[95px] h-[40px]">
            <Image src="/icons/Approved Status.svg" layout="fill" />
          </div>
        </div>
        <div className="w-[20%] py-[10px] px-[15px]">
          Auth: Create account modal
        ...
        <div className="w-[10%] flex items-center gap-[5px]">
          <input
            type="radio"
            className={`w-[18px] h-[18px] accent-pending`}
            checked
          />
          <p>High</p>
        </div>
      ...
      <div className="flex pl-[2px]  items-center text-[13px]">
        ...
        <div className="w-[10%]">
          <div className="relative w-[95px] h-[40px]">
            <Image src="/icons/In Review Status.svg" layout="fill" />
          </div>
        </div>
        <div className="w-[20%] py-[10px] px-[15px]">
          Auth: Create account modal
        ...
        <div className="w-[10%] flex items-center gap-[5px]">
          ...
          <input
            type="radio"
            className={`w-[18px] h-[18px] accent-likeRed`}
            checked
          />
          <p>Critical</p>
        </div>
